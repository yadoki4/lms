    ...
    <>
      <div className={`${className}${appendClass} p-10`}>
        <div className="flex flex-col mb-1 py-2">
          ...
          <h3 className='text-center text-base font-semibold font-[Poppins] text-black-1'>{ sessionStorage.getItem('Name') }</h3>
          <h3 className='text-center text-base font-normal font-[Poppins] text-gray-1'>Computer Science</h3>
          <h3 className='text-center text-base font-semibold font-[Poppins] text-black-1'>Admin</h3>
        </div>
