  ...
  return (
    ...
    {profile && (
      <div className="w-full mt-5">
        <div className="flex flex-col lg:flex-row justify-between mx-4 lg:mx-24 rounded-3xl bg-white">
          <div className="flex w-full lg:w-3/6 flex-col gap-2 px-4 lg:px-6 py-3">
            <div>
          ...
          <div className="px-4 lg:px-20 py-10 lg:py-20 flex justify-center items-center">
            <div className="flex flex-col justify-center items-center gap-5">
              <p className="text-[#000000] font-poppins font-semibold text-xl lg:text-2xl">
                Profile Picture
              </p>
              <div className="w-40 h-40 lg:w-52 lg:h-48 bg-gray-400 rounded-full"></div>
              <button className="font-poppins font-bold text-xs lg:text-sm text-white bg-orange-logo rounded-2xl w-24 lg:w-32 justify-center items-center px-2 py-2">
                Upload
              </button>
            </div>
          </div>
    ...
    {account && (
      <div className="w-full mt-5">
        <div className="flex flex-col mx-4 lg:mx-24 px-4 lg:px-6 py-6 bg-white">
          <div>
            <p className="font-poppins font-semibold text-[#000000] text-xl lg:text-2xl">
              Change Password
            </p>
          </div>
          <div className="mt-2 flex flex-col gap-3">
            ...
            <div className="flex flex-col">
              ...
              />
              <label className="text-[#475467] font-normal font-inter text-sm mt-1">
        ...
        <div className="mt-4 flex flex-col mx-4 lg:mx-24 px-4 lg:px-6 py-6 rounded-3xl bg-white">
          <div>
            <p className="font-poppins font-semibold text-[#2B2D42] text-xl lg:text-2xl">
              Language Preference
            </p>
          </div>
          <div className="mt-3">
            <p className="font-inter font-medium text-[#2B2D42] text-sm lg:text-base">
              Select Language
            </p>
          </div>
          <div className="flex w-full rounded-xl h-16 bg-white mt-2 px-2 py-2">
            <div className="flex items-center justify-between rounded-lg w-full border border-[#D0D5DD]">
              <p className="ml-2 font-poppins font-bold text-[#2B2D42] text-xs lg:text-sm">
    ...
    {notification && (
      <div className="w-full mt-5">
        <div className="flex flex-col gap-4 px-4 lg:px-6 py-3 mx-4 lg:mx-24 rounded-3xl bg-white">
          <div>
            <p className="font-poppins font-semibold text-[#2B2D42] text-xl lg:text-2xl">
              Notifications
            </p>
          ...
          <div>
            <p className="font-poppins font-semibold text-[#2B2D42] text-lg lg:text-xl">
              Email Notification
            </p>
          </div>
          <div className="flex justify-between">
            <p className="font-poppins font-normal text-[#2B2D42] text-lg lg:text-xl">
          ...
          <div className="flex justify-between">
            <p className="font-poppins font-medium text-[#2B2D42] text-lg lg:text-2xl">
              Class A
            </p>
            <input
              type="checkbox"
