    ...
    <div className="w-ful flex flex-col gap-10 mx-8">
      <div className="w-full bg-white rounded-md flex flex-col md:flex-row justify-between px-5 py-5 gap-2">
        ...
        <div className="flex flex-col gap-3  ">
          <p className="font-poppins text-['#2B2D42'] font-extrabold text-5xl  ">
            Hi Max,
          </p>
          <p className="font-poppins text-['#2B2D42'] font-bold text-4xl ">
            Welcome!
          </p>
          <p className="font-poppins text-['#2B2D42'] font-normal text-2xl">
